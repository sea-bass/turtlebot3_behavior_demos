...
def generate_launch_description():
    ...
    sim_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(bringup_dir, 'launch', 'tb3_world.launch.py')),
        launch_arguments={
            'namespace': namespace,
    ...
    block_spawner_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(bringup_dir, 'launch', 'block_spawner.launch.py')),
    )
